      ...
      <div className="grid md:grid-cols-2 gap-8 mt-8 items-start">
        ...
        <div className="flex flex-col items-start space-y-4">
          ...
          <p className="text-xl md:text-base">
            ...
            <br /> rights to that Broadsider's name
            <br />
            and likeness. Meaning you as the
            <br /> holder and only you as the holder
            <br />
            have the ability to exploit your
            <br /> character commercially and <br /> continue telling their
            story in any
            <br /> way you like, on any platform you <br /> wish.
          </p>
        </div>
      </div>
    </div>
