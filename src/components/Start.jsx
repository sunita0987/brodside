...
const Start = () => {
  return (
    <section className="bg-white py-10 px-4 md:px-16 text-gray-800 font-sans">
      <h2 className="text-xl md:text-3xl font-bold mb-6 ff-Neue Machina">
      ...
      <div className="grid md:grid-cols-2">
        ...
        <div className=" bg-[#7CA3D6] p-6  w-full">
          <h3 className="font-bold text-lg mb-2  text-bold ff-Neue Machina">
            Broadside is set in a new <br /> Solar Punk storyworld
          </h3>
          <p className="text-sm md:text-base text-gray-700 text-regular">
